...
export class ApplicationsComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  // - listen to that observable (ie, yield) and get data then -- with debounce to handle overlapping events
  ...
  public updateFilters(filters: FiltersType) {
    ...
    // FOR FUTURE USE
    // get total number using updated filters
    this.applicationService.getCount(this.filters, null)
      .takeUntil(this.ngUnsubscribe)
      .subscribe(count => {
        console.log('totalNumber =', count);
